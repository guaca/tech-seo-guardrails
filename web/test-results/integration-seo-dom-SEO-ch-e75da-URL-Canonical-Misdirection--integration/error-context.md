...
- Name: integration/seo-dom.spec.js >> SEO checks for: Product8 page (/product8) >> [metadata] Raw HTML canonical should not point to the wrong URL (Canonical Misdirection)
...
Expected: "http://localhost:3000/product8"
Received: "http://localhost:3000/product8/"
```
...
- generic [active] [ref=e1]:
  - heading "Product 8" [level=1] [ref=e2]
  - img "Product 8" [ref=e3]
```