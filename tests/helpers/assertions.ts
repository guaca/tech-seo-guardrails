...
/**
 * True when a check was generated by the Basic contract wizard — existence /
 * minimum-length semantics instead of an exact `value` match.
 */
export function isBasicCheck(checkConfig: any): boolean {
  return !!checkConfig && typeof checkConfig === 'object' && checkConfig.mode === 'basic';
}
